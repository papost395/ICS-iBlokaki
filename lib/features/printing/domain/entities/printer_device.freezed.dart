...
mixin _$PrinterDevice {
 ...
 String get id; String get shopId; String get name; ConnectionType get connectionType; String get address; PrinterRole get role; bool get isUtf8; bool get isCp737; int get paperSize;
...
@useResult
$Res call({
 String id, String shopId, String name, ConnectionType connectionType, String address, PrinterRole role, bool isUtf8, bool isCp737, int paperSize
});
...
/// Create a copy of PrinterDevice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? shopId = null,Object? name = null,Object? connectionType = null,Object? address = null,Object? role = null,Object? isUtf8 = null,Object? isCp737 = null,Object? paperSize = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String shopId,  String name,  ConnectionType connectionType,  String address,  PrinterRole role,  bool isUtf8,  bool isCp737,  int paperSize)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PrinterDevice() when $default != null:
return $default(_that.id,_that.shopId,_that.name,_that.connectionType,_that.address,_that.role,_that.isUtf8,_that.isCp737,_that.paperSize);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String shopId,  String name,  ConnectionType connectionType,  String address,  PrinterRole role,  bool isUtf8,  bool isCp737,  int paperSize)  $default,) {final _that = this;
switch (_that) {
case _PrinterDevice():
return $default(_that.id,_that.shopId,_that.name,_that.connectionType,_that.address,_that.role,_that.isUtf8,_that.isCp737,_that.paperSize);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String shopId,  String name,  ConnectionType connectionType,  String address,  PrinterRole role,  bool isUtf8,  bool isCp737,  int paperSize)?  $default,) {final _that = this;
switch (_that) {
case _PrinterDevice() when $default != null:
return $default(_that.id,_that.shopId,_that.name,_that.connectionType,_that.address,_that.role,_that.isUtf8,_that.isCp737,_that.paperSize);case _:
  return null;
...
class _PrinterDevice implements PrinterDevice {
  const _PrinterDevice({required this.id, required this.shopId, required this.name, required this.connectionType, required this.address, required this.role, this.isUtf8 = false, this.isCp737 = false, this.paperSize = 80});
...
/// Create a copy of PrinterDevice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? shopId = null,Object? name = null,Object? connectionType = null,Object? address = null,Object? role = null,Object? isUtf8 = null,Object? isCp737 = null,Object? paperSize = null,}) {
